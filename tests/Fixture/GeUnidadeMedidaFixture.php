...
/**
 * GeUnidadeMedidaFixture
 */
class GeUnidadeMedidaFixture extends TestFixture
{
    /**
     * Table name
     *
     * @var string
     */
    public $table = 'ge_unidade_medida';
    /**
     * Fields
     *
     * @var array
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'ge_unidade_medida_descricao_key' => ['type' => 'unique', 'columns' => ['descricao'], 'length' => []],
        ],
    ];
